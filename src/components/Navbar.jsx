...
const Navbar = () => {
    ...
    const getLinkClass = (path) => {
        if (path === '/' && location.pathname === '/') {
            return 'text-primary font-bold underline'; // Active style for Home
        }
        return location.pathname.startsWith(path) && path !== '/'
            ? 'text-primary font-bold underline' // Active style for other paths
            : 'hover:text-primary';
    };
...
//                     <Link className='mr-2'>Profile</Link>
